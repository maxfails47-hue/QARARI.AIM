...
export function InputScreen() {
  ...
  // "Don't know the price" — lets the user skip entering a numeric price;
  // offeredPrice is sent as null and the report focuses on market price only.
      ...
      <div className="rounded-2xl border border-amber-500/15 bg-gradient-to-b from-zinc-900/80 to-[#0B0B0F] p-6 shadow-2xl">
        <div className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            {priceUnknown ? (
              <div className="flex h-10 items-center rounded-md border border-dashed border-zinc-700 bg-zinc-800/30 px-3 text-sm text-zinc-500">
