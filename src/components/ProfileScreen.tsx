...
export function ProfileScreen() {
  ...
  if (authLoading || (session?.user && !user)) {
    return (
      <div className="mx-auto flex min-h-[60vh] max-w-md items-center justify-center px-4 py-6">
        <div className="h-8 w-8 animate-spin rounded-full border-2 border-shary border-t-transparent" />
      </div>
    );
  }
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText("https://shary-aim.vercel.app");
    setCopied(true);
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 pb-24">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-shary-dark">{t("profile")}</h1>
      </div>

      {/* Profile Header */}
      <div className="mb-6 rounded-2xl border border-shary/15 bg-gradient-to-b from-zinc-900/80 to-[#FFFFFF] p-6 shadow-lg">
        <div className="flex items-center gap-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-shary to-shary-dark shadow-lg">
      ...
      {/* Share Card */}
      <div className="mb-6 rounded-2xl border border-shary/20 bg-gradient-to-br from-shary/10 to-transparent p-5 shadow-xl shadow-shary/5">
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-shary/20 text-shary">
            <Share2 className="h-5 w-5" />
          </div>
          <div>
            <h3 className="text-sm font-bold text-shary-dark">
        ...
        <div className="relative mb-4">
          <div className="flex items-center gap-2 rounded-xl border border-zinc-200 bg-zinc-100/70 p-2 pl-3">
            <span className="flex-1 truncate text-xs text-zinc-500">shary-aim.vercel.app</span>
            <button 
              onClick={handleCopyLink}
              className="flex h-8 items-center gap-1.5 rounded-lg bg-shary px-3 text-[11px] font-bold text-[#FFFFFF] transition-all active:scale-95"
            >
        ...
        <div className="flex gap-2">
          <a 
            ...
            target="_blank"
            rel="noreferrer"
            className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white/60 py-2.5 text-xs font-medium text-zinc-700 transition-colors hover:border-emerald-500/30 hover:text-emerald-400"
          >
          ...
          <a 
            ...
            target="_blank"
            rel="noreferrer"
            className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white/60 py-2.5 text-xs font-medium text-zinc-700 transition-colors hover:border-sky-500/30 hover:text-sky-400"
          >
      ...
      <div className="mb-6 space-y-3">
        <div className="rounded-xl border border-zinc-200 bg-white/60 p-4">
          <div className="flex items-center gap-3">
            <User className="h-5 w-5 text-shary-dark/70" />
            <div className="flex-1">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white/60 p-4">
          <div className="flex items-center gap-3">
            <Mail className="h-5 w-5 text-shary-dark/70" />
            <div className="flex-1">
        ...
        {user.phone && (
          <div className="rounded-xl border border-zinc-200 bg-white/60 p-4">
            <div className="flex items-center gap-3">
              <Phone className="h-5 w-5 text-shary-dark/70" />
              <div className="flex-1">
        ...
        {user.country && (
          <div className="rounded-xl border border-zinc-200 bg-white/60 p-4">
            <div className="flex items-center gap-3">
              <MapPin className="h-5 w-5 text-shary-dark/70" />
              <div className="flex-1">
                <p className="text-xs text-zinc-500">{t("profileCountry")}</p>
                <p className="text-sm text-zinc-800">{t(user.country)}</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="mb-6 rounded-xl border border-zinc-200 bg-white/60 p-5">
        <h3 className="mb-3 text-sm font-bold text-shary-dark">{t("contactSupport")}</h3>
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border border-shary/20 bg-shary/5 px-3 py-2.5 text-sm font-medium text-shary-dark transition-colors hover:bg-shary/10"
        >
